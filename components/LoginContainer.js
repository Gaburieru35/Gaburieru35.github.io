    ...
    fetchUser(controller, tipo){
        ...
        fetch(`http://4.227.162.137:8080/${controller}/logar/${email}`, {
            ...
            if(senha === data.senha){
                ...
                let hrefOficina = window.location.protocol + `//auto-mech-oficina-h31vdcar3-gabrielmatosmartins-projects.vercel.app/home` //localhost:3000/home?id=${data.userId}&tipo=${tipo}
